...
namespace WebGetApi.Controllers
{
    ...
    public class m_CompaniesRegistry_mainNewController : ApiController
    {
        ...
        public async Task<IHttpActionResult> t_Disqualification(ICollection<m_CompaniesRegistry_DisOrders> t_Disqualification)
        {
        ...
        public async Task<IHttpActionResult> Posts_Entity(m_CompaniesRegistry_main postModel)
        {
            ...
            try
            {
                ...
                foreach (var item in postModel.m_CompaniesRegistry_items)
                {
                ...
                foreach (var item in postModel.m_CompaniesRegistry_itemsChange)
                {
                    if (string.IsNullOrEmpty(item.CompanyName) && string.IsNullOrEmpty(item.CompanyNameZH))
                    {
                        continue;
