...
namespace WebGetApi.Controllers
{
    ...
    /// </summary>
    [RoutePrefix("api/iPsychologicalSociety")]
    public class i_PsychologicalSocietyController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Post(entityCommMain entityCommMain)
        {
            ...
            try
            {
                ...
                if (entityCommMain.i_PsychologicalSociety != null)
                {
                    foreach (var item in entityCommMain.i_PsychologicalSociety)
                    {
                    ...
                    if (entityCommMain.i_PsychologicalSociety.Count > 0)
                    {
                        var tmpfirst = entityCommMain.i_PsychologicalSociety.First();
                        ...
                        if (tmpExitItem)
                        {
                            ...
                            foreach (var item in entityCommMain.i_PsychologicalSociety)
                            {
                                if (!string.IsNullOrEmpty(item.Name_En))
                                {
                                    ...
                                    if (getItem != null)
                                    {
                                        ...
                                        getItem.Name_En = item.Name_En;
                                        getItem.Name_Cn = item.Name_Cn;
                                    ...
                                    {
                                        tmpMain.i_PsychologicalSociety.Add(getItem);
                                    }
        ...
        {
            return db.i_PsychologicalSociety.Count(e => e.tkeyNo == id && e.tLang == lang) > 0;
        }
        private i_PsychologicalSociety gwd_PsychologistsList_itemsByNo(string id, long lang, long tindex)
        {
            return db.i_PsychologicalSociety.Where(e => e.tkeyNo == id && e.tLang == lang).FirstOrDefault();
        }
